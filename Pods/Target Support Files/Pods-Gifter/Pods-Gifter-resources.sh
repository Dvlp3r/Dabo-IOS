...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "HHTabListController/HHTabList/darkPattern.png"
  install_resource "HHTabListController/HHTabList/list-landscape.png"
  install_resource "HHTabListController/HHTabList/list-landscape@2x.png"
  install_resource "HHTabListController/HHTabList/list.png"
  install_resource "HHTabListController/HHTabList/list@2x.png"
