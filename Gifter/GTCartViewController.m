...
- (void)loadContent {
    ...
    if (cartItems) {
        ...
        //Load Fake information for now
        NSString *strJSON = @"[ \
                                {\
                                    \"feed_from\" : \"custom\", \
                                    \"id\" : 10, \
                                    \"image\" : \"http://api.daboapp.com/uploads/56a8a3be94d758.18264189.jpg\",  \
                                    \"landing_page\" : \"\",  \
                                    \"manufacturer\" : \"\", \
                                    \"name\" : \"Aldo Crisco Cross Body\", \
                                    \"price\" : \"$45\" \
                                }, \
                                { \
                                    \"feed_from\" : \"custom\", \
                                    \"id\" : 6, \
                                    \"image\" : \"http://api.daboapp.com/uploads/56a891ae53f163.05863013.jpg\", \
                                    \"landing_page\" : \"\", \
                                    \"manufacturer\" : \"\", \
                                    \"name\" : \"Calvin Klein Women's Jacket \", \
                                    \"price\" : \"$53.62 - 109.99\" \
                                }, \
                                { \
                                    \"feed_from\" : \"custom\", \
                                    \"id\" : 7, \
                                    \"image\" : \"http://api.daboapp.com/uploads/56a897c433ba17.78078704.jpg\", \
                                    \"landing_page\" : \"\", \
                                    \"manufacturer\" : \"\", \
                                    \"name\" : \" Ray-Ban Men's Aviator Large Metal Aviator Sunglasses\", \
                                    \"price\" : \"$89\" \
                                }, \
                                { \
                                    \"feed_from\" : \"custom\", \
                                    \"id\" : 8, \
                                    \"image\" : \"http://api.daboapp.com/uploads/56a89a70db2127.90966704.jpg\", \
                                    \"landing_page\" : \"\", \
                                    \"manufacturer\" : \"\", \
        ...
        NSArray *jsonObject = [NSJSONSerialization JSONObjectWithData:[strJSON dataUsingEncoding:NSUTF8StringEncoding]
                                                              options:0 error:NULL];
        
        [items addObjectsFromArray:jsonObject];
        if ([jsonObject count] > 0) {
            [self.navigationController.tabBarItem
             setBadgeValue:[NSString stringWithFormat:@"%ld", (unsigned long)[jsonObject count]]];
        }
    };
